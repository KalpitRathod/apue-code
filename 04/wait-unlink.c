/* ============================================================================
 * The Ghost File Trick
 * ============================================================================
 * When you unlink() a file, its directory entry disappears instantly. But if a process still has it open, the kernel waits to delete the physical disk blocks until the file is closed. This trick creates an invisible temporary file that automatically cleans up if the program crashes.
 * ============================================================================
 */
