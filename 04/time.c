 ...
 * The Epoch Timeline
 * ============================================================================
 * UNIX time is a single integer tracking the number of seconds since midnight on January 1, 1970. No leaps, no timezones—just raw ticking seconds. All complexity of years, months, and leap seconds is purely an illusion created by the C standard library functions explored here.
 * ============================================================================
 */
#include <err.h>
#include <stdio.h>
