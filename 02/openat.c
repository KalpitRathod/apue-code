/* ============================================================================
 * Defeating Race Conditions: openat
 * ============================================================================
 * As systems became highly parallel, malicious users exploited timing gaps between checking a directory and opening a file inside it (TOCTOU attacks). The 'openat' system call was a modern addition to POSIX to anchor file operations to a specific, unchangeable directory file descriptor.
 * ============================================================================
 */
/*
