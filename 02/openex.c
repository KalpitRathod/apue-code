/* ============================================================================
 * The Portal to the Filesystem
 * ============================================================================
 * The open() syscall is the gateway between User Space and Kernel Space. When this program calls open(), the kernel traverses the directory tree, checks permissions, allocates an entry in the system-wide open file table, and hands back a file descriptor ticket.
 * ============================================================================
 */
/*
