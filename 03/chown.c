 ...
 * ============================================================================
 * In classic UNIX, a user could give a file away to another user without root privileges. But systems administrators hated this, because users would 'give' massive files to other people to avoid disk quotas! Modern UNIX restricts chown to the superuser to stop quota cheating.
 * ============================================================================
 */
