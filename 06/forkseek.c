 ...
 * Sharing the Boombox
 * ============================================================================
 * When you fork, the child inherits the file descriptors. However, they share the EXACT SAME underlying open file table entry in the kernel, which means they share the file offset pointer. If the child reads 5 bytes, the parent's next read starts at byte 6.
 * ============================================================================
 */
