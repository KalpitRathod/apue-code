 ...
 * Erasing History
 * ============================================================================
 * Environment variables are just a massive array of strings above the stack. Unsetting one usually just nulls out a pointer without freeing memory, leading to obscure leaks.
 * ============================================================================
 */
