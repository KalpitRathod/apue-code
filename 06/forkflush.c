/* ============================================================================
 * The Phantom Output Bug
 * ============================================================================
 * If you printf() without a newline, the data sits in a user-space memory buffer. If you then call fork(), that buffer is perfectly cloned into the child. Now BOTH processes will eventually flush and print the exact same data to the screen! A classic, confusing UNIX gotcha.
 * ============================================================================
 */
