 ...
 * ============================================================================
 * The 'const' keyword in C wasn't just a linter rule; it was a promise to the compiler. It allowed developers to confidently map variables into read-only memory segments. But because C fundamentally trusts the programmer, you can cast away 'const' and invoke undefined behavior (like crashing the hardware).
 * ============================================================================
 */
/*
