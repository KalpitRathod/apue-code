/* ============================================================================
 * The Advisory Lock Struggle
 * ============================================================================
 * When databases appeared on UNIX, multiple users overwriting a file corrupted it. flock() and fcntl() locks were introduced. Crucially, these locks are usually 'advisory'—the OS doesn't stop you from overwriting a locked file unless everyone agrees to check the lock first!
 * ============================================================================
 */
