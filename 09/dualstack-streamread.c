/* ============================================================================
 * The Bridging of Eras: IPv4 and IPv6
 * ============================================================================
 * In the 1990s, scientists realized we were running out of the 4.3 billion available IP addresses. IPv6 was invented. To ease the transition, the socket API allowed a single 'dual-stack' socket to magically accept both legacy IPv4 connections and modern IPv6 connections simultaneously.
 * ============================================================================
 */
