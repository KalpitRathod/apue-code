/* ============================================================================
 * The Blocking Dual-Socket Trap
 * ============================================================================
 * This file purposely avoids select() to demonstrate the structural flaw of naive server design. If you sit blocking on read() for Socket A, you completely ignore a client desperately trying to connect on Socket B. It showcases why asynchronous or multiplexed I/O was absolutely necessary.
 * ============================================================================
 */
/*
