/* ============================================================================
 * The Core Dump: SIGQUIT
 * ============================================================================
 * Pressing ^\ sends SIGQUIT. Its historical purpose was brutal but useful: kill the program immediately, but leave behind a 'core dump'—a literal snapshot of memory dumped to the filesystem so programmers could perform an autopsy on why it froze.
 * ============================================================================
 */
