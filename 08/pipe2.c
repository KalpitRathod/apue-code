/* ============================================================================
 * The Two-Way Tunnel Attempt
 * ============================================================================
 * Pipes are strictly one-way (half-duplex). If you want two programs to talk back and forth, you must physically build two separate pipes and crisscross them. This file explores the complexity of wiring a makeshift two-way telegraph system out of one-way components.
 * ============================================================================
 */
