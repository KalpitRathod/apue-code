 ...
 * IPC Memory Mapping
 * ============================================================================
 * Message passing is safe, but it requires copying data from User A to Kernel, then Kernel to User B. Shared Memory ignores this. The MMU maps the exact same physical RAM chip into two disparate process address spaces. It is blisteringly fast, but terrifyingly prone to race conditions if not synced.
 * ============================================================================
 */
