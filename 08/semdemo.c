/* ============================================================================
 * The Traffic Light: Semaphores
 * ============================================================================
 * Edsger Dijkstra invented the Semaphore in 1965 (naming the operations 'Proberen' and 'Verhogen'—Dutch for try and increment). When processes share memory, they need a traffic light to prevent simultaneous writes. This code implements that raw locking mechanism to tame concurrency chaos.
 * ============================================================================
 */
